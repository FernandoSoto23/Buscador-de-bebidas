...
export default function Modal() {
    ...
    const selectedRecipi = useAppStore(state=>state.selectedRecipe);
    const handleClickFavorite = useAppStore(state=>state.handleClickFavorite);
    const favoritesExists = useAppStore(state=>state.favoriteExists);
            ...
            <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                    ...
                    <div className='mt-5 flex justify-between gap-4'>
                        ...
                        >{favoritesExists(selectedRecipi.idDrink) ? 'Eliminar Favorito' : 'Agregar a Favoritos'}</button>
                    </div>
                    </Dialog.Panel>
                </Transition.Child>
                </div>
